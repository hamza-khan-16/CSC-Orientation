  ...
  return (
    <footer className="mt-24">
      <svg viewBox="0 0 1200 40" className="block w-full text-primary" preserveAspectRatio="none">
        <path
          d="M0,20 C120,4 240,36 360,20 S600,4 720,20 960,36 1080,20 1200,4 1200,20"
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
          strokeLinecap="round"
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-sm text-muted-foreground">
              Chandrabhan Sharma College — where curious students become engineers, researchers and
              founders.
            </p>
...
<<<<<<< HEAD
              {[Instagram].map((I, i) => (
                <a
                  key={i}
                  href="https://www.instagram.com/chandrabhansharma.college?igsh=cnNjeWN3aWhhNHA="
                  aria-label="social"
...
>>>>>>> 45fd08b0aa9fd7e1d06db408977c9bcdc88ef5ee
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              ...
              <li>
                <Link to="/explore" hash="faculty" className="hover:text-primary">
                  Faculty
                </Link>
              </li>
              <li>
                <Link to="/explore" hash="labs" className="hover:text-primary">
                  Labs
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-border/60 px-6 py-4 text-center text-xs text-muted-foreground">
          © {new Date().getFullYear()} Chandrabhan Sharma College · CSC. Handcrafted with ✎.
        </div>
      </div>
    </footer>
  );
